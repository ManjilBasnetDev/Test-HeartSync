...
public class Swipe extends JFrame {
            ...
            label.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (label == exploreLabel) {
                        ...
                        // For now, show a message that chat is not implemented
    ...
    private void setupProfiles() {
        ...
        try {
            ...
            List<UserProfile> otherProfiles = heartsync.database.DatingDatabase.getInstance().getExplorableProfiles(currentUsername);
